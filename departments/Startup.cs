...
namespace departments
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContextPool<DepartmentContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DataContextConnection")));

            //services.AddTransient(typeof(DbContext), typeof(DepartmentContext));
